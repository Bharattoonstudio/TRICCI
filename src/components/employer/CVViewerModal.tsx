...
export default function CVViewerModal({ cvUrl, candidateName, onClose }: CVViewerModalProps) {
  ...
  return (
    <div ref={containerRef} className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm">
      <div className="w-full h-full max-w-4xl max-h-screen flex flex-col bg-background rounded-2xl overflow-hidden">
        ...
        <div className="bg-card border-b border-border px-4 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <button onClick={handleFullscreen} className="p-2 hover:bg-muted rounded-lg" title="Fullscreen">
