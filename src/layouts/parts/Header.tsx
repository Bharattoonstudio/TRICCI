...
{role === 'candidate' && (
<>
<Link to="/candidate/interviews" onClick={() => setOpen(false)}
className="flex items-center gap-2.5 px-3 py-2.5 rounded-lg text-sm text-foreground hover:bg-muted transition-colors">
<Zap size={14} className="text-muted-foreground" />
My Interviews
</Link>
<Link to="/candidate/offers" onClick={() => setOpen(false)}
className="flex items-center gap-2.5 px-3 py-2.5 rounded-lg text-sm text-foreground hover:bg-muted transition-colors">
<Star size={14} className="text-muted-foreground" />
My Offers
</Link>
<Link to="/candidate/documents" onClick={() => setOpen(false)}
className="flex items-center gap-2.5 px-3 py-2.5 rounded-lg text-sm text-foreground hover:bg-muted transition-colors">
...
<Link to="/signup-fresh" onClick={() => setIsMobileMenuOpen(false)}
