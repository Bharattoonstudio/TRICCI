...
export default function SetPasswordPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setLoading(true);
    try {
      const response = await fetch('/api/auth/set-password-with-otp', {
        method: 'POST',
  ...
  return (
    <>
      <Helmet>
        <title>Set New Password — TRICCI</title>
        <link rel="canonical" href="https://tricci.in/set-password" />
      </Helmet>
      ...
      <div className="min-h-screen bg-background flex items-center justify-center p-4">
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-muted-foreground mt-2">Set a strong password for your account</p>
          </div>
