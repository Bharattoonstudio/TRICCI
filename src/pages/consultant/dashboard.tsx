...
import ConsultantSubmissionsList from '@/components/consultant/ConsultantSubmissionsList';
          ...
          <AnimatePresence mode="wait">
            ...
            {activeTab === 'cvbank' && (
              <motion.div key="cvbank" initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}
                exit={{ opacity: 0, y: -12 }} transition={{ duration: 0.25 }}>
                <ConsultantCVBank onSubmitSuccess={() => setRefreshSubmissions(v => v + 1)} />
              </motion.div>
            )}
            ...
            {activeTab === 'submissions' && (
              <motion.div key="submissions" initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}
                ...
                <ConsultantSubmissionsList refresh={refreshSubmissions} />
              </motion.div>
            )}
