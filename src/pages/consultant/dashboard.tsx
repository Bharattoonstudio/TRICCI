              ...
              <div className="max-w-2xl">
                ...
                <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.1 }}>
                  ...
                  <p className="text-white/50 text-base leading-relaxed max-w-lg">
                    Every mandate you work on is a placement waiting to happen. Submit your best candidates and earn <strong className="text-white/80">6% of CTC</strong> — no subscription, no cap.
                  </p>
                </motion.div>
                ...
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.5 }}
                  ...
                  {[
                    { icon: Trophy, label: '6% of CTC', color: '#ffd035' },
                ...
                <div className="rounded-2xl border p-6" style={{ background: '#0d0d0d', borderColor: '#ffffff0d' }}>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    {[
                      ...
                      { icon: Wallet, title: 'You Get Paid', desc: 'Your 6% placement fee is transferred to your bank within 3 business days of candidate joining.', color: '#22c55e' },
                    ].map(step => (
              ...
              <motion.div key="resources" initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                  {[
                    ...
                    { icon: HelpCircle, title: 'FAQ — Fees & Payouts', desc: 'How is the 6% calculated? When do I get paid? All payout questions answered.', color: '#ffd035', tag: 'FAQ' },
