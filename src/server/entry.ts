...
import admin_users_bulk_action_post from "./api/admin/users/bulk-action/POST";
...
import candidate_cv_preview_get_new from "./api/candidate/cv-preview/GET";
...
import otp_login_send_post from "./api/otp/login/send/POST";
import otp_login_verify_post from "./api/otp/login/verify/POST";
...
import employer_placements_by_application_get_130 from "./api/employer/placements/by-application/[applicationId]/GET";
...
import employer_submissions_id_documents_request_post_122 from "./api/employer/submissions/[id]/documents/request/POST";
import employer_submissions_id_documents_get_123 from "./api/employer/submissions/[id]/documents/GET";
import employer_applications_id_documents_request_post_124 from "./api/employer/applications/[id]/documents/request/POST";
import employer_applications_id_documents_get_125 from "./api/employer/applications/[id]/documents/GET";
import consultant_submissions_id_documents_get_126 from "./api/consultant/submissions/[id]/documents/GET";
import consultant_submissions_id_documents_upload_post_127, { multerMiddleware as consultant_submissions_id_documents_upload_post_127_upload } from "./api/consultant/submissions/[id]/documents/upload/POST";
import candidate_documents_get_128 from "./api/candidate/documents/GET";
import candidate_documents_upload_post_129, { multerMiddleware as candidate_documents_upload_post_129_upload } from "./api/candidate/documents/upload/POST";
import admin_fee_config_get_131 from "./api/admin/fee-config/GET";
import admin_fee_config_put_132 from "./api/admin/fee-config/PUT";
import candidate_consent_grant_post_133 from "./api/candidate/consent/grant/POST";
import candidate_consent_withdraw_post_134 from "./api/candidate/consent/withdraw/POST";
import candidate_interviews_get_135 from "./api/candidate/interviews/GET";
import candidate_offers_get_136 from "./api/candidate/offers/GET";
import candidate_offers_id_accept_post_137 from "./api/candidate/offers/[id]/accept/POST";
import candidate_offers_id_reject_post_138 from "./api/candidate/offers/[id]/reject/POST";
import employer_placements_id_offer_withdraw_post_139 from "./api/employer/placements/[id]/offer/withdraw/POST";
import employer_placements_id_get_140 from "./api/employer/placements/[id]/GET";
import submissions_id_get_141 from "./api/submissions/[id]/GET";
import employer_submissions_id_interview_round_create_post_142 from "./api/employer/submissions/[id]/interview/round/create/POST";
import employer_submissions_id_interview_rounds_get_143 from "./api/employer/submissions/[id]/interview/rounds/GET";
import employer_submissions_id_interview_round_roundId_reschedule_post_144 from "./api/employer/submissions/[id]/interview/round/[roundId]/reschedule/POST";
import employer_submissions_id_interview_round_roundId_submit_feedback_post_145 from "./api/employer/submissions/[id]/interview/round/[roundId]/submit-feedback/POST";
import employer_placements_id_offer_draft_post_146 from "./api/employer/placements/[id]/offer/draft/POST";
import employer_placements_id_offer_submit_approval_post_147 from "./api/employer/placements/[id]/offer/submit-approval/POST";
import employer_placements_id_offer_approve_post_148 from "./api/employer/placements/[id]/offer/approve/POST";
import employer_placements_id_offer_reject_approval_post_149 from "./api/employer/placements/[id]/offer/reject-approval/POST";
...
app.post("/api/admin/users/bulk-action", admin_users_bulk_action_post);
...
app.get("/api/candidate/cv-preview", candidate_cv_preview_get_new);
...
app.post("/api/otp/login/send", otpSendRateLimiter, otp_login_send_post);
app.post("/api/otp/login/verify", otpVerifyRateLimiter, otp_login_verify_post);
...
app.get("/api/employer/placements/by-application/:applicationId", employer_placements_by_application_get_130);
...
app.post("/api/employer/submissions/:id/documents/request", employer_submissions_id_documents_request_post_122);
app.get("/api/employer/submissions/:id/documents", employer_submissions_id_documents_get_123);
app.post("/api/employer/applications/:id/documents/request", employer_applications_id_documents_request_post_124);
app.get("/api/employer/applications/:id/documents", employer_applications_id_documents_get_125);
app.get("/api/consultant/submissions/:id/documents", consultant_submissions_id_documents_get_126);
app.post("/api/consultant/submissions/:id/documents/upload", consultant_submissions_id_documents_upload_post_127_upload, consultant_submissions_id_documents_upload_post_127);
app.get("/api/candidate/documents", candidate_documents_get_128);
app.post("/api/candidate/documents/upload", candidate_documents_upload_post_129_upload, candidate_documents_upload_post_129);
app.get("/api/admin/fee-config", admin_fee_config_get_131);
app.put("/api/admin/fee-config", admin_fee_config_put_132);
app.post("/api/candidate/consent/grant", candidate_consent_grant_post_133);
app.post("/api/candidate/consent/withdraw", candidate_consent_withdraw_post_134);
app.get("/api/candidate/interviews", candidate_interviews_get_135);
app.get("/api/candidate/offers", candidate_offers_get_136);
app.post("/api/candidate/offers/:id/accept", candidate_offers_id_accept_post_137);
app.post("/api/candidate/offers/:id/reject", candidate_offers_id_reject_post_138);
app.post("/api/employer/placements/:id/offer/withdraw", employer_placements_id_offer_withdraw_post_139);
app.get("/api/employer/placements/:id", employer_placements_id_get_140);
app.get("/api/submissions/:id", submissions_id_get_141);
app.post("/api/employer/submissions/:id/interview/round/create", employer_submissions_id_interview_round_create_post_142);
app.get("/api/employer/submissions/:id/interview/rounds", employer_submissions_id_interview_rounds_get_143);
app.post("/api/employer/submissions/:id/interview/round/:roundId/reschedule", employer_submissions_id_interview_round_roundId_reschedule_post_144);
app.post("/api/employer/submissions/:id/interview/round/:roundId/submit-feedback", employer_submissions_id_interview_round_roundId_submit_feedback_post_145);
app.post("/api/employer/placements/:id/offer/draft", employer_placements_id_offer_draft_post_146);
app.post("/api/employer/placements/:id/offer/submit-approval", employer_placements_id_offer_submit_approval_post_147);
app.post("/api/employer/placements/:id/offer/approve", employer_placements_id_offer_approve_post_148);
app.post("/api/employer/placements/:id/offer/reject-approval", employer_placements_id_offer_reject_approval_post_149);
...
import("./db/migrations/add_document_submission_system.js").then(m => m.migrateDocumentSubmissionSystem()).catch(console.error);
import("./db/migrations/add_placement_direct_application_support.js").then(m => m.migratePlacementDirectApplicationSupport()).catch(console.error);
import("./db/migrations/add_welcome_sent_at.js").then(m => m.migrateWelcomeSentAt()).catch(console.error);
import("./db/migrations/add_offer_approval_workflow.js").then(m => m.migrateOfferApprovalWorkflow()).catch(console.error);
...
import("./db/migrations/cleanup_orphaned_jobs.js").then(m => m.cleanupOrphanedJobs()).catch(console.error);
